...
/**
 * Custom Qualcomm RIL for Asus ZenFone 5 LTE
 *
 * {@hide}
 */
public class AsusLteRIL extends RIL implements CommandsInterface {
    private Message mPendingGetSimStatus;

    public AsusLteRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public AsusLteRIL(Context context, int networkMode, int cdmaSubscription) {
